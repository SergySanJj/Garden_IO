...
@WebServlet("/api/" + API.AddGardener.ENDPOINT)
public class AddGardenerEndpoint extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("Adding gardener");
        DatabaseAction.tryAddUser(req, resp, login, password, name, "gardener");
    }
}
